...
vit_model = models.vit_l_32(weights=models.ViT_L_32_Weights.DEFAULT).to(device)
...
output_file = "../data/processed/posters_vit_L_32_features.npz"  # Replace with the path for saving features
